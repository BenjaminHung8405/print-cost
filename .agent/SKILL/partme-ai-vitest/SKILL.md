# --- agentskill.sh ---
# slug: partme-ai/vitest
# owner: partme-ai
# contentSha: 2e4ca16
# installed: 2026-06-04T17:04:54.562Z
# source: https://agentskill.sh/partme-ai/vitest
#
# IMPORTANT: After this skill is used for the first time, assess how
# useful and functional it was, then rate it using:
#   /learn feedback partme-ai/vitest <1-5> [optional comment]
