...
**Full deployment, operations, and maintenance guide for PrintCost on Mac Mini M4**

---

## ⚠️ Prerequisites

**Before starting this guide, follow [GETTING_STARTED.md](GETTING_STARTED.md) first!**

This guide assumes:
- ✅ Database is running and verified (`docker ps | grep printcost_db`)
- ✅ `.env` is configured with strong password
...
### ✅ System Requirements
- [ ] Mac Mini M4 (10-core CPU, 16GB RAM, 100GB free disk)
- [ ] macOS 12+
- [ ] Docker Desktop or OrbStack
- [ ] Stable network connection

### ✅ Pre-Deployment Security
- [ ] Strong DB password (min 16 chars, mix of letters/numbers/symbols)
- [ ] `.env` file in `.gitignore` (never commit secrets!)
- [ ] SSH keys setup (if using Git)
- [ ] Backup strategy decided (local + cloud optional)
- [ ] Remote access planned (Tailscale/Cloudflare if needed)

### ✅ Optional Enhancements
- [ ] SSL/TLS certificates (for external access)
- [ ] rclone setup (for cloud backup to Google Drive/S3/etc)
- [ ] Monitoring dashboard (Grafana/Prometheus)
- [ ] Log aggregation (ELK stack)

---

## 🚀 Quick Deploy (After GETTING_STARTED.md)

```bash
# Already done in GETTING_STARTED.md:
...
```
NAMES              STATUS
printcost_db       Up 20s (healthy)
printcost_nginx    Up 20s
printcost_backend  Up 20s
printcost_frontend Up 20s
```
